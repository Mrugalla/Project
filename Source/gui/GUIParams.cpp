...
gui::Parametr::ModDial::ModDial(Utils& u, Parametr& _parametr) :
...
void gui::Parametr::ModDial::paint(Graphics& g)
{
...
gui::Parametr::ModDial::State gui::Parametr::ModDial::getState() const noexcept { return state; }
...
void gui::Parametr::ModDial::mouseDown(const Mouse& mouse)
{
    switch (state)
    {
    case State::MaxModDepth:
...
void gui::Parametr::ModDial::mouseDrag(const Mouse& mouse)
{
...
void gui::Parametr::ModDial::mouseUp(const Mouse& mouse)
{
...
gui::Parametr::Parametr(Utils& u, PID _pID, bool _modulatable) :
...
gui::PID gui::Parametr::getPID() const noexcept { return param.id; }

void gui::Parametr::setLocked(bool lckd)
{
    locked = lckd;
    if (locked)
    {
