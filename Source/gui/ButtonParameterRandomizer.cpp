...
gui::ButtonParameterRandomizer::ButtonParameterRandomizer(Utils& u) :
...
void gui::ButtonParameterRandomizer::add(Param* p)
{
    randomizables.push_back(p);
}

void gui::ButtonParameterRandomizer::add(std::vector<Param*>&& p)
{
    randomizables = p;
}

void gui::ButtonParameterRandomizer::add(const std::vector<Param*>& p)
{
    randomizables = p;
}

void gui::ButtonParameterRandomizer::add(const RandFunc& p)
{
    randFuncs.push_back(p);
}

void gui::ButtonParameterRandomizer::operator()()
{
    juce::Random rand;
...
void gui::ButtonParameterRandomizer::mouseExit(const Mouse&)
{
    setTooltip(makeTooltip());
    repaint();
}

gui::String gui::ButtonParameterRandomizer::makeTooltip()
{
    Random rand;
    static constexpr float count = 200.f;
